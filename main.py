...
print("GOOGLE_TOKEN_PATH:", os.getenv("GOOGLE_TOKEN_PATH"))
...
planner_instructions = read_instructions("VA.md") + read_instructions("planner.md")
planner_agent = Agent(
    name="Planner Agent",
...
# Executor Agent
executor_instructions = read_instructions("VA.md") + read_instructions("executor.md")
